...
//
// La semana tiene 5 días de fuerza (1 = lunes … 5 = viernes) y 2 de caminata
// (6 y 7), que no se recorren ni bloquean nada. Recorrer corre el día perdido y
// todos los siguientes; lo que ya no cabe antes del domingo queda como no hecho.
// La semana NUNCA invade la siguiente: cada lunes arranca limpio porque las
// decisiones se guardan por semana ISO.
 ...
 */
export function planSemana({ hoy, sesiones, decisiones = DECISIONES_VACIAS }) {
